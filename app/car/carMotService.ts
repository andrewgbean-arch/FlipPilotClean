...
export async function fetchMotData(reg: string): Promise<CarRecord["mot"] | undefined> {
  try {
    ...
    // DVLA returns an array of vehicles → each with motTests[]
