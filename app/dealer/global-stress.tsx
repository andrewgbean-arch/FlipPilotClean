...
import { GlobalMarketStressScreen } from "../../src/features/dealer-ai/screens/GlobalMarketStressScreen";
import { getGlobalAutomotiveAISuite } from "../../src/features/dealer-ai/DealerIntelligenceAPI";

export default function GlobalStress() {
  const oems = [
    {
      name: "Ford",
  ...
  return <GlobalMarketStressScreen data={ai.globalStress} />;
}
