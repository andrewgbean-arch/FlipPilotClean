...
export default function FinanceSuiteV16Dashboard() {
  const { vehicle: vehicleParam, buyer: buyerParam } = useLocalSearchParams();

  const vehicle =
    typeof vehicleParam === "string" ? JSON.parse(vehicleParam) : vehicleParam;

  const buyer =
    typeof buyerParam === "string" ? JSON.parse(buyerParam) : buyerParam;
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      {/* Approval */}
      <SupernovaCard title="Finance Approval AI" glow style={styles.card}>
