...
import { GlobalGovernanceBrainScreen } from "../../src/features/dealer-ai/screens/GlobalGovernanceBrainScreen";
...
export default function Governance() {
  ...
  return <GlobalGovernanceBrainScreen data={ai.governanceBrain} />;
}
